...
http_archive(
    ...
    sha256 = "c5b1dbe462c8165aeef8bf66116d5808a968eeb5a2efc4718eed6a9c674e2c36",
    strip_prefix = "rules_sass-1.60.0",
    urls = [
        "https://github.com/bazelbuild/rules_sass/archive/1.60.0.zip",
    ],
)
